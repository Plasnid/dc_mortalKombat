...
class PurinPurinPurin implements DigiPet{
    ...
    */
      defenseCharacteristics:Armor = {strongAgainst:"grain", weakAgainst:"meat"} ;
    ...
    constructor(tamName: string){
        ...
        this.hp = 60;
        console.log(`my name is ${this.tamName} and you look weak like a baby.`);

        //DO THIS:  use 'this' and foods to make an array of OffensiveFoods
        this.foods = [
          {foodName: "Sesame Seed Short Sword", foodCat: "grain", damage: 15},
          {foodName: "Red Bean Pudding Bomb", foodCat: "grain", damage: 15},
          {foodName: "Toxic Sewage Meat", foodCat: "meat", damage: 15},
          {foodName: "Sword Of Big Baguettes", foodCat: "grain", damage: 3},
          {foodName: "Dumpling Of Big Dunks", foodCat: "grain", damage: 2},
          {foodName: "Whole Wheat Wizard Wand", foodCat: "grain", damage: 2},
          {foodName: "Mad Cow Injection", foodCat: "meat", damage: 2},
          {foodName: "Jerky Javelin", foodCat: "meat", damage: 2},
          {foodName: "Prune Pit Cannon", foodCat: "fruit", damage: 2},
...
export default PurinPurinPurin;
